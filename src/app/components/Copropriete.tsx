        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600">
                Tous les diagnostics obligatoires pour vendre un bien : DPE, amiante, plomb, électricité, gaz, termites, ERP, Loi Carrez.
              </p>
            </Link>
            <Link
              to="/location"
            ...
            >
              ...
              <p className="text-gray-600">
                Diagnostics obligatoires pour louer un bien : DPE, amiante, plomb, électricité, gaz, ERP, mesurage Loi Boutin.
              </p>
            </Link>
          </div>
        </div>
